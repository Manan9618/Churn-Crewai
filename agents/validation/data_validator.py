...
def create_data_validator(llm) -> Agent:
    return Agent(
        ...
        goal=(
            ...
            "missing value thresholds, and target column integrity before any preprocessing "
            "begins. Raise clear errors if validation fails."
        ),
        backstory=(
            ...
            "contain 'Yes'/'No', and missing values must not exceed 1% per column."
        ),
        tools=[
            validate_schema_tool,
            validate_data_types_tool,
